...
static inline u64 ptp_cavium_tstamp2time(struct ptp_cavium_clock *clock,
					 u64 tstamp)
{
	return timecounter_cyc2time(&clock->time_counter, tstamp);
}

static inline int ptp_cavium_clock_index(struct ptp_cavium_clock *clock)
{
